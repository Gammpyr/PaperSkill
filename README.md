...
1. Для работы с номерами телефонов и SMS
django-phonenumber-field — поле для номеров телефонов с валидацией и форматами

phonenumbers — парсинг, валидация и форматирование номеров (используется phonenumber-field)
